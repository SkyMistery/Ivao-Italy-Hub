...
/**
 * The layout of everything under `/staff/<dept>/categories`: it owns the department in the address
 * and the guard on it, and draws whichever child matched — the list at `/`, the form at `/{id}`.
 *
