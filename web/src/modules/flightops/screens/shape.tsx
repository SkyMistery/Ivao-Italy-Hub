...
import { callsignRuleSchema, hubSchema, rotationSchema, type TourEditorTab } from '../schemas';

import { NewButton } from './NewButton';
import { useStaff } from './hooks';

/**
 * The shape of a tour besides its legs (design M2 §1.3, §1.6, §2.7, §8.3): the tabs of the tour's editor for its hubs
 * and rotations, its subtours and its callsign constraints — generated lists, each row opened in a generated form on a
 * page of its own, as every back office screen of the hub (plan §16.6). Only the legs are a table (T7a).
 */
...
function useRowId(name: 'hubId' | 'rotationId' | 'ruleId'): number | null {
