...
**Piano:** v0.52. **Design M1:** v1.15 (`03-design-m1.md`). **Piano di implementazione M1:** v2.13
...
**Test:** 471 .NET verdi (306 unit + 165 integrazione) + **276 Vitest** + **51 smoke Playwright** +
