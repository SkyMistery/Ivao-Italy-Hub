...
**Piano:** v0.54. **Design M1:** v1.15 (`03-design-m1.md`). **Piano di implementazione M1:** v2.14
...
**Test:** 471 .NET verdi (306 unit + 165 integrazione) + **279 Vitest** + **52 smoke Playwright** +
