...
estensioni del nucleo su 16 (la n.9 non è servita); 42 endpoint a mano nel modulo, contati per famiglia. **Da decidere con Carmine**: se
quel conto per famiglia sostituisce in §16.6 la metrica dei verbi di M1 (proposta del rapporto). Toccate §8.3, §9.5, §16.6 (i numeri
misurati) e lo stato in testa.
