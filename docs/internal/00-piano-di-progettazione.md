...
**Versione documento:** 1.05 — 24 settembre 2026 (**il contratto dell'agente del validatore**, fase T19b di M2: `/api/flightops/agent` con `Hub-Agent-Contract`, `docs/agent-contract.md`; gli esiti dell'agente non si auditano e dicono sulla riga chi li ha mandati; un controllo ha un solo esecutore)
