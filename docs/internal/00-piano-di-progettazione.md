...
**Versione documento:** 1.04 — 24 settembre 2026 (**i token personali**, fase T19a di M2: `hub_personal_tokens`, lo schema del token accettato solo dalla sua audience, `/me/tokens`; e l'audit delle righe dei moduli, che non c'era)
