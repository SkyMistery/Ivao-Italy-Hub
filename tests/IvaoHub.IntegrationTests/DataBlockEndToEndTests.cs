...
public sealed class DataBlockEndToEndTests(MariaDbFixture mariaDb) : IAsyncLifetime
{
    ...
    public async Task EveryDataBlockTypeHasAProvider()
    {
        ...
        // Six of the core, the one M0 built, `myWork` of D3 and the first of a module, the public errors
        // of the tours (M2, T9), and the count is written out so that a block lost in a merge is
